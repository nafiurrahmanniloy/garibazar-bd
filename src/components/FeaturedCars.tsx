  ...
  return (
    <section className="cars-section py-20 px-6" id="browse-cars">
      <div className="max-w-[1280px] mx-auto">
        ...
        {/* View All */}
        <button className="flex items-center justify-center gap-2 mx-auto mt-12 px-10 py-3.5 bg-transparent border border-white/[0.06] rounded-lg text-white font-semibold text-[0.95rem] cursor-pointer transition-all hover:border-[var(--accent)] hover:text-[var(--accent)] hover:bg-[var(--accent-subtle)] group">
          View All Cars
